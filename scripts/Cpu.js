class Cpu{
    constructor(c, bola){
        ...
        this.pele = new Image();
        this.pele.width = 50;
        this.pele.height = 100;
        this.pele.src ="assets/pele.png";
        this.pele.addEventListener("load", () =>{
            this.draw()
        });
    ...
    draw(){
       ...
       this.c.drawImage(this.pele, this.x, this.y, this.pele.width, this.pele.height);
    }
}